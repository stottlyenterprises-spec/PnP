...
test("account restoration stays in the background during normal use",()=>{
 assert.equal(page.includes("Restoring your D.E.E.D.S."),false);
 assert.equal(page.includes('accountGatewayLayer restoring'),false);
});
