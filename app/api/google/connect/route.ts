...
export async function GET(){
 ...
 url.search=new URLSearchParams({client_id:id,redirect_uri:`${app.replace(/\/$/,"")}/api/google/callback`,response_type:"code",scope:"https://www.googleapis.com/auth/calendar.readonly https://www.googleapis.com/auth/gmail.readonly https://www.googleapis.com/auth/drive.appdata",access_type:"offline",include_granted_scopes:"true",prompt:"consent",state}).toString();
