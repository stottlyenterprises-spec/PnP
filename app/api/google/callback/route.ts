...
export async function GET(req:NextRequest){
 ...
 res.cookies.delete("google_state");res.cookies.delete("google_connect_slot");res.cookies.delete("google_native_return");return res;
}
